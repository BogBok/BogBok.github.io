...
function gameLoop(that) {
    ...
    if (that.player.money > 500000 || gemsBool === true) {
    ...
    if (that.player.money === Infinity || infBool === true) {
    ...
    that.player.marketing[0].mult = that.player.marketing[0].multincrease * ((that.player.gems / 1000) + 1)
    that.player.marketing[1].mult = that.player.marketing[1].multincrease * ((that.player.gems / 1000) + 1)
    that.player.marketing[2].mult = that.player.marketing[2].multincrease * ((that.player.gems / 1000) + 1)

    that.player.artists[0].mult = that.player.artists[0].multincrease * ((that.player.infpoints / 1000) + 1)
    that.player.artists[1].mult = that.player.artists[1].multincrease * ((that.player.infpoints / 1000) + 1)
    that.player.artists[2].mult = that.player.artists[2].multincrease * ((that.player.infpoints / 1000) + 1)
    ...
    that.player.marketing[1].amount += (that.player.marketing[2].amount * that.player.marketing[2].mult * diff) / 100
    ...
    that.player.artists[1].amount += (that.player.artists[2].amount * that.player.artists[2].mult * diff) / 100
    ...
    that.player.inf[1].amount += (that.player.inf[2].amount * that.player.inf[2].mult * diff) / 100
